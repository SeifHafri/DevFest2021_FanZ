  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.title}>My TVs</Text>
        <Text style={styles.simpletext3}>Control Your TVs</Text>
        ...
        <View style={styles.both}>
          ...
          >
            <Image
              ...
              style={styles.tv}
            ></Image>
            <Text style={styles.simpletext}>Salon TV</Text>
            <Text style={styles.simpletext2}>Online</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.choseava}>
            ...
            ></Image>
            <Text style={styles.simpletext}>Salon TV</Text>
            <Text style={styles.simpletext2}>Offline</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.both2}>
          <TouchableOpacity style={styles.choseava2}>
            <Image
              resizeMode="contain"
